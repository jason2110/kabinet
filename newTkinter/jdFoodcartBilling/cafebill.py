...
root.title("JD Food Cart")

Tops = Frame(root,bg="teal",width = 1600,height=50,relief=SUNKEN)
Tops.pack(side=TOP)
...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="JD Food Cart",fg="Black",bd=10,anchor='w')
...
def Ref():
    ...
    PayTax=((costoffries +  costoflargefries + costofburger + costoffilet +  costofcheeseburger + costofdrinks)*0.12)
...
lblreference = Label(f1, font=( 'aria' ,20, 'bold' ),text="Order No.",fg="brown",bd=20,anchor='w')
